...
### R73. The one-document contract landed mid-charter and `doit packet spec-writer` did not come with it (L-planner-0016, 2026-09-17 ~11:40Z)
...
### R74. `doit alloc adr` handed out ids another pane already held, and only a manual check caught it (L-planner-0016, ~11:56Z)
...
### R75. A spec-writer's output can be VALID and still unauditable, and the refusal arrives one step too late (L-planner-0016, ~11:54Z)
...
### R76. Three spawns in one Planner context died to caps while their work was fine, and the cap is the thing that is wrong (L-planner-0016, 2026-09-17 09:15–11:15Z)
