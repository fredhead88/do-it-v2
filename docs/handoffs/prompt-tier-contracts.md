...
`doit reap` destroys only what patch-id proves is on main. One real charter
through the ten contracts is what is left in that queue.
Last updated: 2026-09-08 (tenth session — the driver loop's seventh item)
