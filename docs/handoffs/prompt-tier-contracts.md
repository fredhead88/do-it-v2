...
carries no block from it. The deploy and tree-cleanup
scripts, and the one real charter, are what is left in that queue.
Last updated: 2026-09-08 (ninth session — the driver loop's sixth item)
...
vet-dep 73; six real spawns through the wrapper]:
